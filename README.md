...
```javascript
randu = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-base-randu@v0.0.8-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/random-base-randu/actions/workflows/test.yml/badge.svg?branch=v0.0.8
[test-url]: https://github.com/stdlib-js/random-base-randu/actions/workflows/test.yml?query=branch:v0.0.8
